...
class AddTaskModel {
  ...
  AddTaskModel(this.task, this.description, this.DueDate, this.DueTime,
      this.notifications);
  ...
  factory AddTaskModel.fromJson(String source) =>
      AddTaskModel.fromMap(json.decode(source) as Map<String, dynamic>);
